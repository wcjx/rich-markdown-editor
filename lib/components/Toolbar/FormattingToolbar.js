    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        !isSelectionInHeading && React.createElement(
          React.Fragment,
          null,
          this.renderMarkButton("bold", _icons.BoldIcon, "Bold"),
          this.renderMarkButton("italic", _icons.ItalicIcon, "Italic"),
          this.renderMarkButton("deleted", _icons.StrikethroughIcon, "Strikethrough"),
          this.renderMarkButton("code", _icons.CodeIcon, "Code")
        ),
        !isSelectionInTable && React.createElement(
          React.Fragment,
          null,
          !isSelectionInHeading && React.createElement(_Separator2.default, null),
          this.renderBlockButton("heading1", _icons.Heading1Icon, "Heading"),
          this.renderBlockButton("heading2", _icons.Heading2Icon, "Subheading"),
          !isSelectionInHeading && this.renderBlockButton("block-quote", _icons.BlockQuoteIcon, "Quote")
        ),
        !isSelectionInHeading && React.createElement(
          React.Fragment,
          null,
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(_icons.LinkIcon, { color: this.props.theme.toolbarItem })
            )
          )
        )
      );
